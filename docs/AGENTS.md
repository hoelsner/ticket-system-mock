...
- when a source document mixes multiple audiences or purposes, split it by dominant concern instead of forcing one large document into a single documentation area
